...
class bigint
{
    ...
    public:
        ...
        bigint(const bigint &source);//copy constructor- pass the object(not int) by ref; so it is const
        ...
        bigint &operator+=(const bigint &other) const; //Adds second to first, modifies first, and returns a reference to first
        ...
        //comparisons
        bool operator==(bigint &second) const;
        bool operator!=(bigint &second) const;
        bool operator<(bigint &second) const;
        bool operator>(bigint &second) const;
        bool operator>=(bigint &second) const;
